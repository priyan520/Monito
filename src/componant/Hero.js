      ...
      <div className="container_custom md:pl-[53px] md:pr-[158px] px-[20px]">
        <div className="con">
          <div className="bg-img absolute top-0 right-0 -z-10 ">
            <img src={require("../asset/Vector.png")} className="xl:w-full md:w-[80%] ml-auto" alt="" />
          </div>
          <div className="side_bg_img absolute 3xl:left-[1780px] 2xl:left-[1140px] hidden lg:block xl:left-[670px] lg:left-[400px] xl:top-[200px] top-[150px]">
            <img src={require("../asset/Vector 74.png")} alt="" />
          </div>
          <div className="main_content flex items-start lg:flex-row flex-col-reverse justify-between">
              ...
              <div className="ren mt-10 flex xl:gap-[66px] gap-[20px] xl:items-center flex-col xl:flex-row">
                <div className="p_1">
                  <button>
                    <a
                      href="#"
                      className="lg:py-[17px] lg:px-[25px] py-[12px] px-[20px] bg-[#0f3659] text-white rounded-full block tracking-wider lg:text-sm text-xs text-center"
                    >
                      Shop Now
                    </a>
                  </button>
                  ...
                  <div className="box">
                    <div className="p_1 flex items-center lg:gap-2 gap-1">
                      <div className="img flex">
                        <img src={require("../asset/Ellipse 6.png")} alt="" />
                        <img
                          src={require("../asset/Ellipse 7.png")}
                          alt=""
                          className="ml-[-10px]"
                        />
                      </div>
            ...
            <div className="p_2">
              <div className="img">
                <img
                  src={require("../asset/dogs_img_1 1.png")}
                  width={"610px"}
                  alt=""
                />
              </div>
              <div className="imges_flote">
                <div className="img">
                  ...
                  />
                  <img
                    src={require("../asset/Ellipse 12.png")}
                    className="absolute md:w-auto w-[14%] top-[16.67%] 3xl:right-[35%] 2xl:right-[42.08%] xl:right-[57%] lg:right-[65%] md:right-[40%] md:left-auto left-[5%]"
                    width={"36px"}
                    alt=""
                  />
                  <img

        ...
        <div className="con">
          <div className="hedding">
            <div className="heddinge_main flex items-center gap-1 justify-center">
              <img
                src={require("../asset/section-vec-l1 2.png")}
                alt=""
              ...
              <img
                src={require("../asset/section-vec-r1 2.png")}
                alt=""
          ...
          <div className="content">
            ...
            <div className="gallary px-5">
              <div className={"box_1 flex gap-[40px] justify-center flex-wrap "+disImg[0]}>
                <img
                  src={require("../asset/Rectangle 20.png")}
                  alt=""
                  className="rounded-[20px] lg:w-[370px] md:w-[300px] w-full hover:scale-110"
                />
                <img
                  src={require("../asset/Rectangle 14.png")}
                  alt=""
                  className="rounded-[20px] lg:w-[370px] md:w-[300px] w-full hover:scale-110"
                />
                <img
                  src={require("../asset/Rectangle 15.png")}
                  alt=""
                  className="rounded-[20px] lg:w-[370px] md:w-[300px] w-full hover:scale-110"
                />
              </div>
              <div className={"box_2 flex gap-[40px] justify-center mt-[54px] flex-wrap "+disImg[1]}>
                <img
                  src={require("../asset/Rectangle 4393.png")}
                  alt=""
                  className="rounded-[20px] lg:w-[370px] md:w-[300px] w-full hover:scale-110"
                />
                <img
                  src={require("../asset/Rectangle 18.png")}
                  alt=""
                  className="rounded-[20px] lg:w-[370px] md:w-[300px] w-full hover:scale-110"
                />
                <img
                  src={require("../asset/Rectangle 4395.png")}
                  alt=""
                  className="rounded-[20px] lg:w-[370px] md:w-[300px] w-full hover:scale-110"
                />
              </div>

      ...
      <div className="container_custom">
        <div className="con">
          <div className="dog_image hidden md:block">
            <img
              src={require("../asset/image 42.png")}
              alt=""
              className="mx-auto xl:mb-[-150px] xl:w-auto w-[80%] lg:mb-[-100px] mb-[-80px] hover:scale-110"
            />
          </div>
          <div className="main_footer md:flex py-[110px] bg-[#FFF5ED] lg:pl-[70px] justify-between lg:pr-[31px] px-[20px]">
            <div className="p_1">
              ...
              <div className="info mt-[41px]">
                <ul>
                  <li>
                    <a href="" className="flex gap-4 items-center  mb-[33px]">
                  ...
                  <li>
                    <a href="" className="flex gap-4 items-center  mb-[33px]">
                      <FaPhoneAlt className="text-[#FE704B] text-[24px]" />{" "}
            ...
            <div className="p_3 md:mt-0 mt-[60px]">
              ...
              <div className="p mt-[20px]">
                <p className="leading-[26px] font-[400] w-[220px] text-[#70717B] xl:text-left xl:mr-auto xl:ml-0 md:text-right md:ml-auto">
                  Pellentesque aliquam sem in tellus fringilla interdum.
                </p>
              </div>
            ...
            <div className="p_bg absolute bottom-0 right-0 z-10 hover:right-[50px] transition-all duration-500 ease-in-out">
              <img
                src={require("../asset/image 134.png")}
                className=""
                alt=""
              />
            </div>
